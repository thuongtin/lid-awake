...
6. Manual hold disabled: assertion should release.
7. Battery guardrail: fake or manual low-battery state should release the assertion and restore closed-lid mode if this app enabled it.
8. Quit app: no app-owned assertion should remain, and closed-lid mode should be restored if this app enabled it.
